...
public class RegistrationMentor extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_mentor);
    ...
    public void onClick(View v) {
        ...
        Intent intent = new Intent(this, LoginMentor.class);
